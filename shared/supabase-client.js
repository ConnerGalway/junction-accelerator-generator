...
// Check if Supabase SDK is loaded (should be included in <head>)
if (typeof window.supabase === 'undefined') {
  console.error('Supabase SDK not loaded. Make sure <script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2"></script> is in the <head>');
} else {
